...
namespace CardGames
{
    public class SnapGame
    {
		...
		private static void DrawGame(Snap myGame)
		{
			...
			if (top != null)
			{
                SwinGame.DrawText("Top Card is " + top.ToString(), Color.White, "GameFont", 10, 20);
                SwinGame.DrawText("Player 1 score: " + myGame.Score(0), Color.White, "GameFont", 10, 50);
                SwinGame.DrawText("Player 2 score: " + myGame.Score(1), Color.White, "GameFont", 10, 80);
				SwinGame.DrawCell (SwinGame.BitmapNamed ("Cards"), top.CardIndex, 521, 153);
			}
			else
			{
                SwinGame.DrawText("No card played yet...", Color.White, "GameFont", 10, 20);
			}
